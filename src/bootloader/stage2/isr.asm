...
; this is like a function defintion 
%macro ISR_NOERRORCODE 1    ;The 1 is the number of parameters the macro accepts.
...
; in this file i called all the macros with parameter so here i can create two macros instead of 255
